...
namespace PorcXarxaAPI.Services
{
    public class EmailService : IEmailService
    {
        ...
        public EmailService(IConfiguration configuration, ILogger logger, SmtpClient smtpClient, IWebHostEnvironment webHostEnvironment)
        {
